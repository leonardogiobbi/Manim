...
class Bhaskara(Scene):
    def construct(self):
        ...
        d1_copy_2 = d1_copy_1.copy()
        d2_copy_2 = d2_copy_1.copy()
        d3_copy_2 = d3_copy_1.copy()
        ...
        d1_copy_3 = d1_copy_2.copy()
        d2_copy_3 = d2_copy_2.copy()
        d3_copy_3 = d3_copy_2.copy()
        ...
        c_square = Polygon(
            ...
            [ds4.get_x(), ds4.get_y(), 0], color=RED, fill_color=RED, fill_opacity=0.8)
        ...
        # punti quadrato
        sqp1 = d1_copy_1.copy().scale(0.72)
